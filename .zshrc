...
plugins=(git macos pip git-flow vi-mode zsh-syntax-highlighting zsh-claude-code-shell docker docker-compose meteor kubectl terraform aws auto-report-longtasks gcloud)
